                                ...
                                <?php foreach ($peserta as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit_peserta.php?id_peserta=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <a href="delete_peserta.php?id_peserta=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus  Data?')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
