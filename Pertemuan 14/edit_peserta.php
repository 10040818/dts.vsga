...
$hasil = $db->query("SELECT peserta.* FROM peserta WHERE peserta.id = '$id_peserta'");
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="update_peserta.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_peserta" value="<?php echo $peserta['nama'] ?>" placeholder="Masukkan Nama Peserta" class="form-control" required>
                            </div>
                            <div class="form-group">
